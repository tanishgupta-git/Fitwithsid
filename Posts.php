...
<!-- header start -->
   <div class="main-area">
    <header>
            <div>
              <p class="page-define"><i class="fas fa-blog"></i> Blog Posts</p>
            </div>
         	...
         	<table>
                ...
                <tr>
                    <td><?php echo $Sr; ?></td>
                     ...
                     echo $PostTitle;?></td>
                     <td><?php if(strlen($Category)>10){$Category=substr($Category,0,8)."...";}
                     echo $Category; ?></td>
                     <td><?php if(strlen($DateTime)>11){$DateTime=substr($DateTime,0,10)."...";}
                     echo $DateTime; ?></td>
                     <td><?php if(strlen($Admin)>6){$Admin=substr($Admin,0,6)."..";}
                     echo $Admin; ?></td>
                     <td><img src="UPLOAD/<?php echo $Image; ?>" width="100x" height="100px"></td>
                     <td>
                        <?php
                     ...
                     <td><a href="EditPost.php?id=<?php echo $Id; ?>"><span class="btn warning">Edit</span></a></td>
                    <td><a href="DeletePost.php?id=<?php echo $Id; ?>"><span class="btn delete">Delete</span></a></td>
